...
return array(
    ...
    'ad_domain_help'			=> 'Đôi khi giống như tên miền email của bạn, nhưng không phải lúc nào cũng vậy.',
	...
	'audit_interval'            => 'Chu kỳ Kiểm kê',
    'audit_interval_help'       => 'Nếu bạn được yêu cầu kiểm kê thường xuyên tài sản của mình, hãy nhập khoảng thời gian theo tháng.',
	'audit_warning_days'        => 'Báo tài sản đến hạn kiểm kê',
    'audit_warning_days_help'   => 'Cảnh báo bạn trước bao nhiêu ngày khi tài sản đến hạn kiểm toán?',
	'auto_increment_assets'		=> 'Tạo ID tài sản tăng tự động',
	'auto_increment_prefix'		=> 'Tiền tố (tùy chọn)',
	'auto_incrementing_help'    => 'Cài đặt tiền tố hiển thị trước ID tài sản',
	'backups'					=> 'Sao lưu',
	'barcode_settings'			=> 'Cài đặt mã vạch',
    'confirm_purge'			    => 'Xác nhận Xóa',
    'confirm_purge_help'		=> 'Nhập văn bản "DELETE" vào hộp dưới đây để xóa các bản ghi của bạn. Việc này không thể được phục hồi.',
	'custom_css'				=> 'CSS tùy chỉnh',
	'custom_css_help'			=> 'Nhập CSS tùy chỉnh. Không bao gồm thẻ &lt;style&gt;&lt;/style&gt.',
    'custom_forgot_pass_url'	=> 'Tùy chọn đường dẫn (URL) đặt lại mật khẩu',
    'custom_forgot_pass_url_help'	=> 'Điều này sẽ thay thế chức năng quên mật khẩu trên màn hình đăng nhập, có ích để trực tiếp người dùng truy cập hoặc quản trị mật khẩu LDAP đặt lại chức năng. Nó sẽ hoàn toàn vô hiệu hóa tính năng quên mật khẩu người dùng.',
  ...
  'default_language'			=> 'Ngôn ngữ mặc định',
    ...
    'display_checkout_date'     => 'Hiển thị ngày bàn giao',
    'display_eol'               => 'Hiển thị EOL ở bảng',
    'display_qr'                => 'Hiển thị mã QR',
	'display_alt_barcode'		=> 'Hiển thị mã vạch Barcode',
	'barcode_type'				=> 'Loại mã vạch 2D',
	'alt_barcode_type'			=> 'Loại mã vạch 1D',
    'eula_settings'				=> 'Cài đặt EULA',
    'eula_markdown'				=> 'Đây là EULA cho phép <a href="https://help.github.com/articles/github-flavored-markdown/">Github</a>.',
    'footer_text'               => 'Văn bản phần Footer',
    'footer_text_help'          => 'Văn bản này sẽ xuất hiện trong chân trang bên phải. Liên kết được phép sử dụng dưới dạng <a href="https://help.github.com/articles/github-flavored-markdown/">Github</a>. Ngắt dòng, tiêu đề, hình ảnh, vv có thể dẫn đến kết quả hiển thị không như mong muốn.',
    ...
    'load_remote_help_text'		=> 'Cài đặt này có thể tải các tập lệnh từ bên ngoài.',
    'login_note'                => 'Lưu ý đăng nhập',
    'login_note_help'           => 'Tùy chọn bao gồm một vài câu trên màn hình đăng nhập của bạn, ví dụ để hỗ trợ những người đã tìm thấy thiết bị bị mất hoặc bị đánh cắp. Trường này chấp nhận <a href="https://help.github.com/articles/github-flavored-markdown/">Github</a>',
    'login_remote_user_text'    => 'Tùy chọn đăng nhập người dùng từ xa',
    'login_remote_user_enabled_text' => 'Cho phép người dùng đăng nhập từ xa',
    ...
    'logo'                    	=> 'Logo',
    'logo_print_assets'         => 'Sử dụng để in',
    'logo_print_assets_help'    => 'Sử dụng nhãn hiệu trên danh sách tài sản ',
    'full_multiple_companies_support_help_text' => 'Hạn chế người dùng (kể cả quản trị viên) giao tài sản của công ty khác vào công ty họ.',
    ...
    'pwd_secure_min'            => 'Ký tự tối thiểu cho mật khẩu',
    'pwd_secure_min_help'       => 'Giá trị tối thiểu là 5',
    'pwd_secure_uncommon'       => 'Ngăn chặn mật khẩu đơn giản',
    'pwd_secure_uncommon_help'  => 'Điều này sẽ không cho phép người dùng sử dụng mật khẩu đơn giản từ 10.000 mật khẩu hàng đầu được báo cáo là đơn giản.',
    'qr_help'                   => 'Bật QR Code trước để gán cho nó',
    ...
    'snipe_version'  			=> 'Phiên bản ứng dung',
    'support_footer'            => 'Hỗ trợ liên kết ở chân trang ',
    'support_footer_help'       => 'Chỉ định ai nhìn thấy các liên kết đến Thông tin người dùng và Hướng dẫn sử dụng',
    'version_footer'            => 'Hiển thị phiên bản ở cuối trang ',
    'version_footer_help'       => 'Chỉ định ai xem phiên bản và build number.',
    'system'                    => 'Thông tin hệ thống',
    'update'                    => 'Cập nhật cài đặt',
    'value'                     => 'Giá trị',
    'brand'                     => 'Thương hiệu',
    'about_settings_title'      => 'Cài đặt Giới thiệu',
    ...
    'next_auto_tag_base'        => 'Thứ tự nhãn tự động tăng',
    ...
    'labels_fontsize'           => 'Kích thước phông chữ',
    'labels_pagewidth'          => 'Chiều rộng nhãn',
    'labels_pageheight'         => 'Chiều cao nhãn',
    'label_gutters'        => 'Khoảng cách (inch)',
    'page_dimensions'        => 'Kích thước trang (inch)',
    'label_fields'          => 'Hiển thị trên nhãn các nội dung',
    'inches'        => 'inch',
    'width_w'        => 'rộng',
    'height_h'        => 'cao',
    'show_url_in_emails'                => 'Liên kết trong email',
    'show_url_in_emails_help_text'      => 'Bỏ chọn hộp này nếu bạn không muốn liên kết lại với cài đặt của mình trong phần chân trang email. Có ích nếu hầu hết người dùng của bạn không đăng nhập.',
    'text_pt'        => 'pt',
    'thumbnail_max_h'   => 'Chiều cao thumbnail tối đa',
    'thumbnail_max_h_help'   => 'Chiều cao tối đa bằng pixel mà hình thumbnail có thể hiển thị trong chế độ xem danh sách. Tối thiểu 25, tối đa 500.',
    'two_factor'        => 'Xác thực hai yếu tố',
    'two_factor_secret'        => 'Mã số xác thực hai yếu tố',
    'two_factor_enrollment'        => 'Đăng ký xác thực hai yếu tố',
    'two_factor_enabled_text'        => 'Kích hoạt xác thực hai yếu tố',
    'two_factor_reset'        => 'Đặt lại xác thực hai yếu tố bí mật',
    ...
    'two_factor_reset_success'          => 'Thiết lập thành công xác thực hai yếu tố',
    'two_factor_reset_error'          => 'Thiết lập lại thiết bị xác thực hai yếu tố không thành công',
    'two_factor_enabled_warning'        => 'Bật xác thực hai yếu tố, nếu hiện tại không được bật hệ thống sẽ buộc bạn phải xác thực ngay lập tức bằng thiết bị được đăng ký Google Auth. Có khả năng bạn phải đăng ký thiết bị của bạn nếu có một thiết bị không đăng ký.',
    'two_factor_enabled_help'        => 'Điều này sẽ bật xác thực hai yếu tố bằng Google Authenticator.',
    'two_factor_optional'        => 'Tùy theo người dùng (Người dùng có thể bật hoặc tắt chức năng này)',
    'two_factor_required'        => 'Bắt buộc cho tất cả người dùng',
    'two_factor_disabled'        => 'Vô hiệu hóa chức năng',
    'two_factor_enter_code'	=> 'Nhập mã xác thực hai yếu tố',
    ...
    'require_accept_signature_help_text'      => 'Bật tính năng này sẽ yêu cầu người dùng ký về việc chấp nhận tài sản.',
    'left'        => 'trái',
    'right'        => 'phải',
    'top'        => 'trên',
    'bottom'        => 'dưới',
    ...
    'zerofill_count'        => 'Chiều dài ký tự của các thẻ tài sản, bao gồm cả số 0 ban đầu',
);
