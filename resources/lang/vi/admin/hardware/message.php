...
return array(
    ...
    'does_not_exist_or_not_requestable' => 'Tài sản đó không tồn tại hoặc không cho phép đề xuất.',
    'assoc_users'	 	=> 'Tài sản này hiện tại đã được bàn giao đến một người dùng và không thể xóa. Đầu tiên xin vui lòng kiểm tra lại tài sản, và cố gắng thử lần nữa. ',
    ...
    'restore' => array(
        'error'   		=> 'Tài sản chưa được khôi phục, bạn hãy thử lại',
        'success' 		=> 'Tài sản được khôi phục thành công.'
    ),

    'audit' => array(
        'error'   		=> 'Kiểm kê tài sản không thành công. Vui lòng thử lại.',
        'success' 		=> 'Kiểm kê thành công tài sản.'
    ),


    'deletefile' => array(
        'error'   => 'Tập tin đã không được xoá. Bạn hãy thử lại.',
        'success' => 'Tập tin đã xoá thành công.',
    ),

    'upload' => array(
        'error'   => 'Tập tin chưa được tải lên. Bạn hãy thử lại.',
    ...
    'import' => array(
        'error'                 => 'Một số tài sản được nhập không chính xác.',
    ...
    'checkout' => array(
        'error'   		=> 'Tài sản chưa được bàn giao, xin vui lòng thử lại',
        'success' 		=> 'Tài sản đã bàn giao thành công.',
        'user_does_not_exist' => 'Người dùng này không tồn tại. Bạn hãy thử lại.',
        'not_available' => 'Tài sản đó không có sẵn để bàn giao!',
        'no_assets_selected' => 'Bạn phải chọn ít nhất một mục trong danh sách'
    ),

    'checkin' => array(
        'error'   		=> 'Tài sản chưa được thu hồi, xin vui lòng thử lại',
        'success' 		=> 'Tài sản đã thu hồi thành công.',
        'user_does_not_exist' => 'Người dùng này không tồn tại. Bạn hãy thử lại.',
    ...
    'requests' => array(
        'error'   		=> 'Tài sản chưa được yêu cầu, vui lòng thử lại',
        'success' 		=> 'Tài sản đã yêu cầu thành công.',
        'canceled'      => 'Yêu cầu tài sản đã được hủy thành công'
    )
