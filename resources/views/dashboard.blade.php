      ...
      <div class="box-body">
        <div class="row">
            ...
            <div class="table-responsive">
                ...
                <table
                    ...
                    <tr>
                        ...
                        <th class="col-sm-3" data-visible="true" data-field="action_type">{{ trans('general.action') }}</th>
          ...
          <div class="col-md-12 text-center" style="padding-top: 10px;">
            <a href="{{ route('reports.activity') }}" class="btn btn-primary btn-sm" style="width: 100%">Xem tất cả</a>
          </div>
        </div><!-- /.row -->
      </div><!-- ./box-body -->
    </div><!-- /.box -->
...
<div class="row">
    <div class="col-md-6">
        <div class="box box-default">
            <div class="box-header with-border">
                <h2 class="box-title">{{ trans('general.assets') }} theo tình trạng</h2>
                <div class="box-tools pull-right">
                    <button type="button" class="btn btn-box-tool" data-widget="collapse" aria-hidden="true">
                        <i class="fa fa-minus" aria-hidden="true"></i>
                        <span class="sr-only">Collapse</span>
    ...
    <div class="col-md-6">
        ...
        <div class="box box-default">
            <div class="box-header with-border">
                <h2 class="box-title">{{ trans('general.categories') }} Tài sản</h2>
                <div class="box-tools pull-right">
            ...
            <div class="box-body">
                <div class="row">
                    ...
                    <div class="col-md-12 text-center" style="padding-top: 10px;">
                        <a href="{{ route('categories.index') }}" class="btn btn-primary btn-sm" style="width: 100%">Xem tất cả</a>
                    </div>
                </div> <!-- /.row -->
